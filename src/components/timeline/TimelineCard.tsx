...
function TimelineCard({
  ...
  return (
    <div
      ...
      } hover:bg-zinc-200/70 dark:hover:bg-zinc-900/80 bg-zinc-200/30 dark:bg-zinc-900/30 hover:shadow-lg transition-all duration-500 max-w-2xl relative flex flex-col text-sm ${tl_point_classes} ${more}`}
    >
      {/* Header*/}
